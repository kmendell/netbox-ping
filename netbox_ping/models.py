...
class PluginSettingsModel(models.Model):
    """Store plugin settings - simple model without NetBox features"""
    class Meta:
    ...
    custom_field_data = models.JSONField(blank=True, null=True, default=dict)
